...
- **Brand-customizable.** All colors and brand styles live in a single file (`references/color-palette.md`). Available with Ramboll brand .
...
```bash
cd .claude/skills/DIAGRAM-SKILL/references
uv sync
